<template>
  <div>
      ...
      <el-table :data="ordersList"
        ...
        <el-table-column prop="order_pay"
          ...
          <template slot-scope="scope">
            ...
            <el-tag type="danger"
                    v-if="scope.row.order_pay==0">未付款</el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="address"
          ...
          <template>
            <el-button type="primary"
                       icon="el-icon-edit"
                       size="mini"
                       @click="editOrders"></el-button>
            <el-button type="success"
                       icon="el-icon-location"
                       size="mini"
                       @click="showLogisticsProgress"></el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="物流进度"
               ...
               width="50%">
      <el-timeline>
        <el-timeline-item v-for="(activity, index) in logisticInfo"
                          :key="index"
